    ...
    <div>
      <div class="card custom-card overflow-hidden">
        <div class="card-body p-0">
          <div
            class="d-sm-flex align-items-top p-4 border-bottom-0 !tw-bg-primary"
          >
            <div>
              <span
                class="avatar avatar-xxl !tw-transition-all !tw-duration-150 avatar-rounded me-3 bg-light-transparent"
              >
